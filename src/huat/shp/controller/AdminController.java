...
import huat.shp.pojo.*;
import huat.shp.service.*;
import huat.shp.util.*;
...
public class AdminController {
	...
	public ModelAndView getCatelogList(@RequestParam("pageNum") int pageNum) {
		...
		List<Catelog> rows = catelogService.getPageCatelog(pageNum, pageSize);
		...
		modelAndView.setViewName("admin/catelog/catelog_list");
		return modelAndView;
	}
